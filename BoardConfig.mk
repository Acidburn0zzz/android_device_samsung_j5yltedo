...
-include vendor/samsung/j5yltedo/BoardConfigVendor.mk
...
# Assert
TARGET_OTA_ASSERT_DEVICE := j5ylte

# Kernel
TARGET_KERNEL_CONFIG := cyanogenmod_j5ylte_defconfig
TARGET_KERNEL_SOURCE := kernel/samsung/j5lte

# Vendor Init
TARGET_UNIFIED_DEVICE := true
TARGET_INIT_VENDOR_LIB := libinit_msm
TARGET_LIBINIT_DEFINES_FILE := device/samsung/j5yltedo/init/init_j5ylte.c
